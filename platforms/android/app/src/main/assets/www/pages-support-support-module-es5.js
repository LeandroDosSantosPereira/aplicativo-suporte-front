...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-support-support-module"], {
  ...
  function srcAppPagesSupportSupportTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function SupportPage(alertCtrl, toastCtrl, authService, activatedRoute, router, formsModule, reactiveFormsModule, domSanitizer) {
      ...
      _createClass(SupportPage, [{
        ...
        value: function ngOnInit() {
          ...
          //Pega usuário logado
          this.id = this.current.getUser(); // Busca usuário logado na classe authService pelo id e trás os dados para o objeto ticket

          this.authService.getItem(this.id).then(function (response) {
            _this.data = response;
            _this.imageSrc = _this.link.urlconnection + _this.data.photo.url;
            _this.user = {
        ...
        value: function update() {
          ...
          console.log(this.user); //Envia o id e o usuário para o método updateItem para a classe authService

          this.authService.updateItem(this.id, this.user).subscribe(function (response) {
    ...
    SupportPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_5__["AlertController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["ToastController"], _auth_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_7__["DomSanitizer"]])], SupportPage);
    /***/
  }
}]);
