...
let AuthService = class AuthService {
    constructor(http) {
        ...
        this.url = this.link.urlconnection + 'api/v1/users';
    ...
    login(credentials) {
        ...
        return this.http.post(`${this.url}/login`, credentials).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(response => response.token));
    }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ConnectionUrl", function() { return ConnectionUrl; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");

class ConnectionUrl {
    constructor() {
        // public urlconnection: string  = "http://localhost:3000/"   
        this.urlconnection = "https://api-suporte.herokuapp.com/";
...
//# sourceMappingURL=default~pages-login-login-module~pages-signup-signup-module~pages-support-support-module~pages-tabs-~cbaf75a9-es2015.js.map